...
namespace Chiro
{
    public class UI_KioskChatState : IUI_StateInterface
    {
        private UI_StatePattern uI_StatePattern;

        public UI_KioskChatState(UI_StatePattern uI_StatePattern)
        {
            this.uI_StatePattern = uI_StatePattern;
        }
